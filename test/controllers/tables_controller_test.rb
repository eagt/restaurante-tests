...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { number: @table.number, restaurante_id: @table.restaurante_id } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { number: @table.number, restaurante_id: @table.restaurante_id } }
